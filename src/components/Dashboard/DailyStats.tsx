...
export const DailyStats: React.FC<DailyStatsProps> = ({ links = [] }) => {
    ...
    return (
        <div
            className="w-full h-full backdrop-blur-md border border-nothing-dark/10 rounded-3xl p-6 shadow-xl flex flex-col items-center justify-between relative overflow-hidden group bg-nothing-base/50"
        >
            {/* Header */}
